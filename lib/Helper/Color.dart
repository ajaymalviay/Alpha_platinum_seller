...
const Color primary =Color(0xff8F4228);
const Color secondary = Color(0xffF2935D);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xffF2935D);
const Color grad2Color = Color(0xffF2935D);
